...
// Deprecated: buildClusterJoinCommand prepares the join command used to add an EC2 instance to the associated cluster.
...
// Deprecated: buildClusterTag returns an EC2 tag required by clusters to mark worker nodes.
...
// Deprecated: setSourceDestCheck sets the Source/Dest. check of an EC2 instance to a specific value.
