...
func (m *ingressRules) Get(resource resource.Resource, host string) (ingresses.Rule, error) {
...
func (m *ingressRules) Upsert(rule ingresses.Rule, paths ...ingresses.Path) error {
...
func (m *ingressRules) Remove(rule ingresses.Rule, paths ...ingresses.Path) error {
