...
require (
	...
	gitlab.com/ignitionrobotics/web/fuelserver v0.0.0-20200220160511-e30fc2dc1ada
	gitlab.com/ignitionrobotics/web/ign-go v0.0.0-20200302171238-48b369571fcf
