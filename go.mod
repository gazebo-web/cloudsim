...
require (
	...
	gitlab.com/ignitionrobotics/web/ign-go/v5 v5.7.1-0.20220803131849-d31c64fa30d0
...
require (
	...
	github.com/elastic/go-elasticsearch/v8 v8.0.0-20200508105138-fc4f6f3c7fc3 // indirect
